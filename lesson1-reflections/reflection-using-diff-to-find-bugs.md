...
It will be helpful to be able to launch your text editor from the command line. See [here](https://gist.github.com/adrianorsouza/df4759b0583dcd112da4) for instructions on how to do this for Sublime. If you have trouble getting this working, videos at the end of the lesson called "Setting up Your Workspace on Windows" and "Setting Up Your Workspace on Mac" will demonstrate this process, so you can wait until then.
...
lesson_1_reflections.txt (you can replace subl with another editor here if you prefer a different one)
